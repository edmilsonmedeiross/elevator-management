...
namespace ElevatorManagementAPI.Api.Data.Mappings
{
  public class ElevatorMapping
    : IEntityTypeConfiguration<ElevatorModel>
  {
    public void Configure(
      EntityTypeBuilder<ElevatorModel> builder
    )
    {
      ...
      builder
        .Property(e => e.QttCables)
        .HasColumnType("int");

      builder
        .Property(e => e.CableGauge)
        .HasColumnType("int");

      builder
        .Property(e =>
          e.IsHouseMachineLess
        )
        .HasColumnType("boolean");

      builder
        .Property(e =>
          e.IsHouseMachineOnTop
        )
        .HasColumnType("boolean");
